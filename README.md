...
- 🎛️ **ASIO support** — connect any ASIO-compatible audio interface or virtual ASIO driver (e.g. [ASIO4ALL](https://asio4all.org), [FlexASIO](https://github.com/dechamps/FlexASIO)) for low-latency instrument, microphone, or DAW input; selectable alongside WASAPI devices in the settings dialog
